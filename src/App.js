...
function App() {
  ...
  <div className="App">
  <h1><span className="uga">UGA</span> <span className="caltrack">CalTrack</span></h1>
  <img src="https://bloximages.newyork1.vip.townnews.com/redandblack.com/content/tncms/assets/v3/editorial/b/15/b158ab90-7480-11e6-99c6-471896ee46d2/57cf42faa88ad.image.jpg?resize=400%2C400" alt="Small Image" className="small-image" />
